<div class="container">
	...
	<div class="painel" id="maps-list">
		<div class="row">
			<div class="col-md-12">
				<button class="ball-button createMapIcon" legenda="Novo Tabuleiro"><i class="fa fa-plus" aria-hidden="true" data-toggle="tooltip" title="Clique aqui, para criar um novo tabuleiro"></i></button>
