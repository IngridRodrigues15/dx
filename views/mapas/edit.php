			...
			<div class="painel-container">
				...
				<div class="col-md-3">
					<div class="painel-options">
						<button class="ball-button hidden saveMap" legenda="Salvar Tabuleiro"><i class="fa fa-floppy-o" aria-hidden="true" data-toggle="tooltip" title="Clique aqui, para salvar o tabuleiro"></i></button>
