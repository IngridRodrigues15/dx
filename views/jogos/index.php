<div class="container">
	...
	<div class="painel" id="games-list">
		<div class="row">
			<div class="col-md-12">
				<button class="ball-button createGameIcon" legenda="Novo Jogo"><i class="fa fa-plus" aria-hidden="true" data-toggle="tooltip" title="Clique aqui, para criar um novo jogo"></i></button>
