		...
		<div class="col-md-12">
			<div class="painel-container">
				<div class="ball-button-box" id="show-new-field-form">
					<button class="ball-button createGameIcon" id="show-new-field-form" legenda="Novo Campo"><i class="fa fa-plus" aria-hidden="true" data-toggle="tooltip" title="Clique aqui, para salvar a ficha"></i></button>
				...
				<div class="ball-button-option hide">
					<div class="campoTextoForm">
						...
						<input type="text" class="campo" id="nomeCampo" name="nomecampo" placeholder="Nome do Campo" required></br>
						<label for="type">Tipo de campo: </label></br>
							<input type="radio" name="type" value="text" id="campo-text" required> <label for="campo-text">Texto</label><br>
							<input type="radio" name="type" value="number" id="campo-number" required> <label for="campo-number">Numerico</label><br>
						<button class="novoCampo">Criar Campo</button>
					</div>
				</div>
				<div class="ball-button-box hidden" id="salvarCamposFicha">
					<button class="ball-button" id="salvarCamposFicha" legenda="Salvar Ficha"><i class="fa fa-floppy-o" aria-hidden="true" data-toggle="tooltip" title="Clique aqui, para salvar a ficha"></i></button>
...
<div class="back-button">
	<a href="<?php echo URL; ?>fichas/index/" class="back-link" legenda="Voltar" data-toggle="tooltip" title="Clique aqui para retornar à página anterior">
